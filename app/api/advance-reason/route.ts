...
import { advanceReasonController } from "../resources/advance-reason/advance-reason.controller";
...
export async function POST(req: Request) {
  try {
    ...
    const result = await advanceReasonController.create(decrypted);
...
export async function GET(req: Request) {
  try {
    ...
    const result = await advanceReasonController.findAll(req);
